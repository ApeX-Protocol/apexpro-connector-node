 ...
 */
export function setGlobalStarkVerificationImplementationNoSanityCheck(fn: VerificationFunction): void {
 ...
 * Set the signature verification implementation that will be used for all StarkSignable objects.
 */
export async function setGlobalStarkVerificationImplementation(fn: VerificationFunction): Promise<void> {
 ...
 * Verify a signature.
 */
export async function verify(key: elliptic.ec.KeyPair, message: BN, signature: SignatureStruct): Promise<boolean> {
