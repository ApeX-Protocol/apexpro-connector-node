 ...
 */
export function asEcKeyPair(privateKeyOrKeyPair: string | KeyPair): elliptic.ec.KeyPair {
 ...
 */
export function asSimpleKeyPair(ecKeyPair: elliptic.ec.KeyPair): KeyPairWithYCoordinate {
 ...
 */
export function asSimpleSignature(ecSignature: elliptic.ec.Signature): SignatureStruct {
  return {
 ...
 */
export function asSimplePublicKey(ecPublicKey: elliptic.curve.base.BasePoint): string {
 ...
 */
export function isValidPublicKey(publicKey: string | { x: string; y: string }): boolean {
  try {
 ...
 */
export function serializeSignature(signature: { r: string; s: string }): string {
 ...
 */
export function deserializeSignature(signature: string): SignatureStruct {
